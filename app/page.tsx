...
export default function PaginaMedaluStore() {
  ...
  // Cargar productos del almacenamiento local guardado permanente
  useEffect(() => {
  ...
  // Función para conservar cambios permanentemente al recargar la página
  ...
  // Guardar un producto nuevo (Global)
